...
export class MailList extends React.Component {
  ...
  converttime(time) {
    var data = { date: "2/22/2018", time: "11:55:43 PM" };
          ...
          return (
            ...
            >
              ...
              <i className="time pull-right">
                {/* old{this.converttime(mail.time).date} */}
                old1/2/2018
              </i>
            </a>
          );
